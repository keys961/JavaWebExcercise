...
public class JavaJudge extends Judge
{
    ...
    public Status judge()
    {
        ...
        String outputName = filename + new Date().getTime();
        String outputPath = "";
        String containerId = "";
        try
        {
            ...
            codePath = path + "\\web\\submit\\" + filename + ".java";
            testcasePath = path + "\\web\\testcase\\" + pid + ".txt";
            answerPath = path + "\\web\\answers\\" + pid + ".txt";
            outputPath = path + "\\web\\outputs\\" + outputName + ".txt";
        ...
        try
        {
            ...
            in.close();
            //Copy
            runProcess = Runtime.getRuntime().exec(new String[]{"docker", "cp", codePath, containerId + ":/" + filename + ".java"});
            runProcess.waitFor();
...
//                System.out.println(new String(info));
    ...
    {
        String code = "public class keys961\n" +
                "{\n" +
                "\tpublic static void main(String[] args)\n" +
                "\t{\n" +
                ...
                "\t}\n" +
                "}\n";
        JavaJudge judge = new JavaJudge(code, "keys961", 1);
